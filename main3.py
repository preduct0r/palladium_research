...
questions_and_files = [   
    ...
    ("Какова сложность разработки ппри применении подхода из статьи?", "development_complexity.txt"),
    ("Какова сложность внедрения при применении подхода из статьи?", "implementation_complexity.txt"),
    ("Каков потенциал коммерциализации при применении подхода из статьи?", "commercialization_potential.txt"),
