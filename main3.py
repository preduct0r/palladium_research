...
questions_and_files = [   
    ...
    ("Какой уровень развития подхода из статьи? Ответ должен быть не больше 3 предложений", "technology_development_level.txt"),
    ("Какова новизна применения палладия при применении подхода из статьи? Ответ должен быть не больше 3 предложений", "palladium_novelty.txt"),
    ("Какова научно-техническая реализуемость внедрения палладия при применении подхода из статьи? Ответ должен быть не больше 3 предложений", "technical_feasibility.txt"),
    ("Какой коммерческий потенциал внедрения палладия при применении подхода из статьи? Если в статье нет информации, попробуй поразмышлять на основе знаний, которые у тебя есть. Ответ должен быть не больше 3 предложений", "commercial_potential.txt"),
    ("Какие конкурентные преимущества палладия в подходе из статьи? Если в статье нет информации, попробуй поразмышлять на основе знаний, которые у тебя есть. Ответ должен быть не больше 3 предложений", "competitive_advantages.txt"),
    ("Какой уровень готовности подхода из статьи с палладием? Ответ должен быть не больше 3 предложений", "technology_readiness_level.txt"),
    ("Какая перспективность рынка разработки при применении подхода из статьи? Если в статье нет информации, попробуй поразмышлять на основе знаний, которые у тебя есть. Ответ должен быть не больше 3 предложений", "market_prospects.txt"),
    ("Какой уровень рыночного коммерческого потенциала при применении подхода из статьи? Если в статье нет информации, попробуй поразмышлять на основе знаний, которые у тебя есть. Ответ должен быть не больше 3 предложений", "market_commercial_potential.txt"),
    ("Какова сложность разработки при применении подхода из статьи? Ответ должен быть не больше 3 предложений", "development_complexity.txt"),
    ("Какова сложность внедрения при применении подхода из статьи? Если в статье нет информации, попробуй поразмышлять на основе знаний, которые у тебя есть. Ответ должен быть не больше 3 предложений", "implementation_complexity.txt"),
    ("Каков потенциал коммерциализации при применении подхода из статьи? Если в статье нет информации, попробуй поразмышлять на основе знаний, которые у тебя есть. Ответ должен быть не больше 3 предложений", "commercialization_potential.txt"),
    ("Какова предполагаемая длительность разработки при применении подхода из статьи? Если в статье нет информации, попробуй поразмышлять на основе знаний, которые у тебя есть. Ответ должен быть не больше 3 предложений", "development_duration.txt"),
]
