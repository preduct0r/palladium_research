...
questions_and_files = [   
    ...
    ("Какое потенциальное потребление палладия при использовании технологии из статьи в кг? Если в статье нет информации, попробуй поразмышлять на основе знаний, которые у тебя есть. Выведи только вывод, ничего больше", "potential_consumption.txt"),
    ("Какой уровень развития технологии из статьи? Выведи только вывод, ничего больше", "technology_development_level.txt"),
    ("Какова новизна применения палладия по технологии из статьи?", "palladium_novelty.txt"),
    ("Какова научно-техническая реализуемость внедрения палладия по технологии из статьи?", "technical_feasibility.txt"),
    ("Какой коммерческий потенциал внедрения палладия по технологии из статьи?", "commercial_potential.txt"),
    ("Какие конкурентные преимущества палладия в технологии из статьи", "competitive_advantages.txt"),
    ("Какой уровень готовности технологии из статьи с палладием", "technology_readiness_level.txt"),
    ("Какая перспективность рынка разработки по технологии из статьи", "market_prospects.txt"),
    ("Какой уровень рыночного коммерческого потенциала при применении технологии из статьи", "market_commercial_potential.txt"),
    ("Какова сложность разработки по технологии из статьи?", "development_complexity.txt"),
    ("Какова сложность внедрения по технологии из статьи?", "implementation_complexity.txt"),
    ("Каков потенциал коммерциализации по технологии из статьи?", "commercialization_potential.txt"),
    ("Какова предполагаемая длительность разработки по технологии из статьи?", "development_duration.txt"),
]
